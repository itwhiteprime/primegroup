...
PM_START_TEXT = """
**Привет {}!** 
Я помогу тебе с администрированием групп.
/help - покажет тебе весь функционал.
...
*Основные* команды:
 ...
 - /help <module name>: информация о модуле.
 - /settings:
   - для личного чата: настройки для всех поддерживаемых модулей.
   - для группы: редирект в чат с настройками модулей.
...
def test(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("Этот пользователь отредактировал сообщение")
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="HELP",
                                                                       ...
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Источник",
                                                                       url="https://github.com/WhitePrime/primegroup")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Да, я уже работаю")
